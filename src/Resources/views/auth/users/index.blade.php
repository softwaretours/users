...
@section('scripts_js')
    ...
    <script>
        ...
        var permissionUpdate = "{{$user->can('users.update')}}";
        var permissionDelete = "{{$user->can('users.destroy')}}";
        var permissionViewRolePermissions = "{{$user->can('role.permissions.view')}}";
        var permissionLoginAs = "{{$user->can('users.login.as')}}";
    </script>
